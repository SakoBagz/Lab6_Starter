...
function initFormHandler() {
	...
	form.addEventListener('submit', event => {
	  ...
	  // B5: Create a recipeObject and populate from formData
	  const recipeObject = {};
	  ...
	  // B9: Get recipes array, add new recipe, and save back to localStorage
	...
	// B11: Add click event listener to clear storage button
